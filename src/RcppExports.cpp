...
RcppExport SEXP _MSctmm_getQ(SEXP nbStatesSEXP, SEXP alphaSEXP, SEXP t_alphaSEXP, SEXP timeSEXP, SEXP lngSEXP, SEXP latSEXP, SEXP modelSEXP) {
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(getQ(nbStates, alpha, t_alpha, time, lng, lat, model));
