...
sample_path_mr_ <- function(a, b, t0, t1, lng0, lat0, lng1, lat1, group, k, nbStates, param, mu, Hmat, rateparam, model) {
    .Call('_MSctmm_sample_path_mr_', PACKAGE = 'MSctmm', a, b, t0, t1, lng0, lat0, lng1, lat1, group, k, nbStates, param, mu, Hmat, rateparam, model)
}
