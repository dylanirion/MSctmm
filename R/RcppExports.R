...
getQ <- function(nbStates, alpha, x_alpha, time, lng, lat, group, model) {
    .Call('_MSctmm_getQ', PACKAGE = 'MSctmm', nbStates, alpha, x_alpha, time, lng, lat, group, model)
}
...
#'
#' Modified from sample_path_mr in ECctmc (Fintzi, 2018)
sample_path_mr2 <- function(a, b, t0, t1, lng0, lat0, lng1, lat1, group, k, nbStates, param, mu, Hmat, alpha, x_alpha, model) {
    .Call('_MSctmm_sample_path_mr2', PACKAGE = 'MSctmm', a, b, t0, t1, lng0, lat0, lng1, lat1, group, k, nbStates, param, mu, Hmat, alpha, x_alpha, model)
}
